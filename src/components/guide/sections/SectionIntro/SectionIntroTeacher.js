            ...
            <div className="container p-3">
                <div className="row align-items-center text-center text-md-start">
                    ...
                    <div className="col-lg-6">
                        ...
                        <p>Dapatkan akses buku, buku teks pelajaran maupun buku non teks, langsung dari Pusat Perbukuan, Kemdikbud.</p>
                        <p>Bapak/ibu guru dapat mengakses buku dalam berbagai format seperti PDF, audio, dan interaktif.</p>
                ...
                <div className="row align-items-center mt-5 text-center text-md-start">
                    ...
                    <div className="col-lg-6">
                        ...
                        <p>Dengan mendaftar dan login pada laman ini, Bapak/Ibu dapat melihat rekam jejak bacaan dan unduhan.</p>
                        <p>Bapak/Ibu dapat pula berperan serta melaporkan, memberikan komentar, dan ulasan pada buku.</p>
                    </div>
                </div>
            </div>
        </section>
...
export default SectionIntroTeacher