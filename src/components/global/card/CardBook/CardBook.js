...
const CardBook = ({ image, title, typeBook, level }) => {
    return (
        <div className={`card border-0 h-100 mt-3 ${styles.card}`}>
            <div className="card-header text-start bg-white p-0 border-0" style={{ backgroundImage: 'url(/assets/image/home/ellipse-1.png)', backgroundRepeat: 'no-repeat', backgroundPosition: 'bottom' }}>
