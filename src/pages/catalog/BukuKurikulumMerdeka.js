...
const BukuTeksK13 = () => {
    ...
    const [lessonBiologi, setLessonBiologi] = useState('')
    const [lessonFisika, setLessonFisika] = useState('')
    const [lessonKimia, setLessonKimia] = useState('')

    useEffect(() => {
        // Default routing endpoints
        let ENDPOINTS_URL = `${BASE_URL}/api/catalogue/${typeCatalogue}?limit=2000&${typeBook}&order_by=updated_at&${level}&${lessonIPA}&${lessonIPS}&${lessonBIndonesia}&${lessonBInggris}&${lessonMatematika}&${lessonPKN}&${lessonInformatika}&${lessonPJOK}&${lessonIslam}&${lessonKristen}&${lessonKatolik}&${lessonHindu}&${lessonBuddha}&${lessonKhonghucu}&${lessonKepercayaan}&${lessonSeniTari}&${lessonSeniMusik}&${lessonSeniRupa}&${lessonSeniTeater}&${lessonSosiologi}&${lessonAntropologi}&${lessonEkonomi}&${lessonGeografi}&${lessonSejarah}&${lessonPrakarya}&${lessonIPAS}&${lessonTeknikKonstruksiDanPerumahan}&${lessonTeknikOtomotif}&${lessonTeknikElektronika}&${lessonTeknikPesawatUdara}&${lessonTeknikKonstruksiKapal}&${lessonTeknikKetenagalistrikan}&${lessonTeknikGeospasial}&${lessonTeknikGeologiPertambangan}&${lessonLayananKesehatan}&${lessonAgriteknologiPengolahanHasilPertanian}&${lessonManajementPerkantoranDanLayananBisnis}&${lessonUsahaLayananPariwisata}&${lessonDesainKomunikasiVisual}&${lessonTeknikFurniture}&${lessonKuliner}&${lessonBiologi}&${lessonFisika}&${lessonKimia}&${class1}&${class2}&${class3}&${class4}&${class5}&${class6}&${class7}&${class8}&${class9}&${class10}&${class11}&${class12}&${latestBook}`;
    ...
    return (
        <Layout>
            ...
            <SectionCatalog
                ...
                setLessonBiologi={() => lessonBiologi === '' ? setLessonBiologi('subject_biologi') : setLessonBiologi('')}
                setLessonFisika={() => lessonFisika === '' ? setLessonFisika('subject_fisika') : setLessonFisika('')}
                setLessonKimia={() => lessonKimia === '' ? setLessonKimia('subject_kimia') : setLessonKimia('')}
